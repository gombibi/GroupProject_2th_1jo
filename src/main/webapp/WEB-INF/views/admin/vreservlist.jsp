...
<body>
	...
	<form id="changecheck" action="ReserveVisitingCommit.mb" method="get"></form>
	<form id="searchcheck" action="ReserveVisitingSearch.mb" method="get"></form>
	...
	<h3>예약상태 확인 - 방문</h3><br>
		<div id="vrtable_div" style="width: 1300px;">
			<table id="vr_select" style="width: 1300px; margin: 0px">
				<tr id="vr_select">
					<td colspan="2" width="20%"><input form="searchcheck" type="radio" class="bigRadio"
						name="option" value="all" checked> <label>전체선택</label></td>
					<td colspan="2"><input form="searchcheck" type="radio" class="bigRadio"
						name="option" value="예약대기"> <label>예약대기</label></td>
					<td colspan="2"><input form="searchcheck" type="radio" class="bigRadio"
						name="option" value="예약승인"> <label>예약승인</label></td>
					<td colspan="2"><input form="searchcheck" type="radio" class="bigRadio"
						name="option" value="예약취소"> <label>예약취소</label></td>
					<td colspan="2"><input form="searchcheck" type="radio" class="bigRadio"
						name="option" value="이용완료"> <label>이용완료</label></td>
				</tr>
				<tr id="vr_select" style="text-align: center;">
					<td colspan="2"><input form="searchcheck" type="radio" class="bigRadio"
						name="pet" value="all" checked> <label>전체선택</label></td>
					<td colspan="2"><input form="searchcheck" type="radio" class="bigRadio"
						name="pet" value="개"> <label>개</label></td>
					<td colspan="2"><input form="searchcheck" type="radio" class="bigRadio"
						name="pet" value="고양이"> <label>고양이</label></td>
					<td colspan="4"></td>
				</tr>
				<tr>
					<td colspan="10" style="text-align: center;">
						<input form="searchcheck" type="submit" class="btn btn-primary" style="background-color: #00d8d5" value="검색">
					</td>
				</tr>
			</table>

			<table id="vr_table" style="text-align-last: center;" >
				<tr bgcolor="00d8d5" style="color: white; text-align-last: center;" id="tr_table_title">
